...
# Scrape data for league average dashboard settings 2019
URL = 'https://www.fangraphs.com/leaders.aspx?pos=all&stats=pit&lg=all&qual=0&type=8&season=2019&month=0&season1=2019&ind=0&team=0,ss&rost=0&age=0&filter=&players=0'
print(URL)
# start scrape
response = requests.get(URL)
soup = BeautifulSoup(response.content, 'html.parser')
...
# Scrape data for league average dashboard settings 2018
URL = 'https://www.fangraphs.com/leaders.aspx?pos=all&stats=pit&lg=all&qual=0&type=8&season=2018&month=0&season1=2018&ind=0&team=0,ss&rost=0&age=0&filter=&players=0'
print(URL)
# start scrape
response = requests.get(URL)
soup = BeautifulSoup(response.content, 'html.parser')
